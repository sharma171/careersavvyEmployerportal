			  ...
			  <Modal className="modal fade" show={state.sendMessage} onHide={()=>dispatch({type:'sendMessage'})} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<Button variant="" type="button" className="close btn"  onClick={() => dispatch({type:'sendMessage'})}>
							<span>×</span>
						</Button>
					</div>
			  ...
			  <Modal show={state.camera}  className="modal fade" id="cameraModal" onHide={() => dispatch({type:'cameraModal'})}>
				<div className="modal-content">
					<div className="modal-header">
						...
						<button type="button" className="close btn" data-dismiss="modal" onClick={() => dispatch({type:'cameraModal'})}>
							<span>×</span>
						</button>
					</div>
					<div className="modal-body">						
			  ...
			  <Modal   show={state.reply}  className="modal fade" id="replyModal" onHide={()=>dispatch({type:'replyModal'})}>
				<div className="modal-content">
					<div className="modal-header">
						...
						<button type="button" className="close btn"  onClick={() => dispatch({type:'replyModal'})}>
							<span>×</span>
						</button>
					</div>
					<div className="modal-body">
