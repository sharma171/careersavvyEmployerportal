							  ...
							  {goSteps === 1 && (
								<>
									...
									<div className="text-end toolbar toolbar-bottom p-2">
										...
										<button className="btn btn-primary sw-btn-next ml-1" onClick={() => setGoSteps(2)}>Next</button>
									</div>	
								</>
							  )}
							  {goSteps === 2 && (
								<>
									...
									<div className="text-end toolbar toolbar-bottom p-2">
										...
										<button className="btn btn-primary sw-btn-next ml-1"  onClick={() => setGoSteps(3)}>Next</button>
									</div>	
								</>
							  )}
							  {goSteps === 3 && (
								<>
									...
									<div className="text-end toolbar toolbar-bottom p-2">
										...
										<button className="btn btn-primary sw-btn-next ml-1"  onClick={() => setGoSteps(4)}>Submit</button>
									</div>	
								</>	
							  )}
