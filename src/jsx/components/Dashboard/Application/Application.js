         ...
         <div className="d-flex flex-wrap mb-4 row">
            ...
            <div className="col-xl-9 col-lg-8 d-flex flex-wrap">
               <div className="me-auto">
                  <Link
                     to="/application"
                     className={`btn btn-primary btn-rounded me-2 mb-2 ${btnActive === 1 ? '' : 'light'}`}
                  ...
                  <Link
                     to="/application"                     
                     className={`btn btn-primary btn-rounded me-2 mb-2 ${btnActive === 2 ? '' : 'light'}`}
                  ...
                  <Link
                     to="/application"                     
                     className={`btn btn-primary btn-rounded me-2 mb-2 ${btnActive === 3 ? '' : 'light'}`}
                  ...
                  <Link
                     to="/application"                     
                     className={`btn btn-primary btn-rounded me-2 mb-2 ${btnActive === 4 ? '' : 'light'}`}
                     onClick={()=>setBtnActive(4)}
                  >
                     Candidate
                  </Link>
               </div>
               <Dropdown className="dropdown custom-dropdown mb-0 me-4 mt-3 mt-sm-0 mb-2">
                  <Dropdown.Toggle
                     variant=""
                           ...
                           <tbody>
                              <tr role="row" className="odd">
                                 ...
                                 <td>
                                    <div className="d-flex">
                                       <Link to={"#"} className="contact-icon me-3" >
                                          <i
                                 ...
                                 <td>
                                    <div className="d-flex align-items-center">
                                       <Link to={"#"}
                                          className="btn btn-rounded btn-outline-dark me-3 ms-auto"
                                       >
                                          Pending
                                       </Link>
                              ...
                              <tr role="row" className="even">
                                 ...
                                 <td>
                                    <div className="d-flex align-items-center">
                                       <Link to={"#"}
                                          className="btn btn-rounded btn-outline-danger me-3 ms-auto"
                                       >
                                          On-Hold
                                       </Link>
                                       <Dropdown className="dropdown float-right custom-dropdown mb-0">
                              ...
                              <tr role="row" className="even">
                                 ...
                                 <td>
                                    <div className="d-flex align-items-center">
                                       <Link to={"#"}
                                          className="btn btn-rounded btn-success me-3 ms-auto"
