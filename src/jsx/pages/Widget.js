                ...
                <div className='card-action mb-sm-0 my-2'>
                  <Nav className='nav nav-tabs' role='tablist'>
                    <Nav.Item className='nav-item'>
                        <Nav.Link	className=''  to='/widget-basic' role='tab' eventKey='day'>Day</Nav.Link>
                    </Nav.Item>
                    <Nav.Item className=''>
                      <Nav.Link
                        className='nav-link'
      ...
      <div className='row'>
        ...
        <div className='col-xl-6 col-lg-6 col-xxl-6 col-sm-6'>
          <div className='card bg-success'>
            ...
            <div className='chart-wrapper'>
              <LineChart height={150} color='#46ffc8' border='#46ffc8' />
            </div>
          </div>
        </div>
      </div>
      <div className='row'>
        <div className='col-lg-6 col-xxl-4 col-sm-6'>
          <div className='card'>
            <div className='card-body pb-0'>
              <div className='row'>
                <div className='col'>
        ...
        <div className='col-lg-6 col-xxl-4 col-sm-12'>
          <div className='card'>
            <div className='card-body'>
